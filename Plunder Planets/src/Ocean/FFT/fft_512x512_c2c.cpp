...
namespace ocean
{
	...
	void fft512x512_create_plan(CSFFT512x512_Plan* plan, ID3D11Device* pd3dDevice, UINT slices)
	{
		...
		pBlobCS = thomas::graphics::Shader::Compile("../res/thomasShaders/fft_512x512_c2c.hlsl", "cs_4_0", "Radix008A_CS");
		pBlobCS2 = thomas::graphics::Shader::Compile("../res/thomasShaders/fft_512x512_c2c.hlsl", "cs_4_0", "Radix008A_CS2");
		assert(pBlobCS);
		assert(pBlobCS2);
