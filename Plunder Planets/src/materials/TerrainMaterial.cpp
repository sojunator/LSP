...
TerrainMaterial::TerrainMaterial(std::string name, Shader* shader) : Material(name, shader)
{
	...
	m_textures.push_back(Texture::CreateTexture(Texture::SamplerState::WRAP, 1, "../res/textures/grass2.png"));
	m_textures.push_back(Texture::CreateTexture(Texture::SamplerState::WRAP, 2, "../res/textures/mountain3.png"));
}
