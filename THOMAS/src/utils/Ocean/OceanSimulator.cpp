	...
	namespace utils
	{
		namespace ocean
		{
			...
			OceanSimulator::OceanSimulator(OceanParameter& params, ID3D11Device* pd3dDevice)
			{
				...
				pBlobUpdateSpectrumCS = graphics::Shader::Compile("../res/thomasShaders/ocean_simulator_cs.hlsl", "cs_4_0", "UpdateSpectrumCS");
				...
				pBlobQuadVS = graphics::Shader::Compile("../res/thomasShaders/ocean_simulator_vs_ps.hlsl", "vs_4_0", "QuadVS");
				pBlobUpdateDisplacementPS = graphics::Shader::Compile("../res/thomasShaders/ocean_simulator_vs_ps.hlsl", "ps_4_0", "UpdateDisplacementPS");
				pBlobGenGradientFoldingPS = graphics::Shader::Compile("../res/thomasShaders/ocean_simulator_vs_ps.hlsl", "ps_4_0", "GenGradientFoldingPS");
				assert(pBlobQuadVS);
			...
			void OceanSimulator::initHeightMap(OceanParameter& params, math::Vector2* out_h0, float* out_omega)
			{
				int i, j;
				math::Vector2 K, Kn;

				math::Vector2 wind_dir = params.wind_dir;
				wind_dir.Normalize();
